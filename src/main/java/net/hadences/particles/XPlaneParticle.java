...
public class XPlaneParticle extends AnimatedRotationalParticle {

    public XPlaneParticle(ClientWorld world, double x, double y, double z,
    ...
    public static class Factory<T extends PlaneParticleEffect> implements ParticleFactory<T> {
        ...
        public Particle createParticle(T planeParticleEffect, ClientWorld clientWorld,
            ...
            return new XPlaneParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ,
